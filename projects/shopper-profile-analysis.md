...
<img src="{{ site.baseurl }}/assets/images/combined%20plot.png" alt="Combined Shopper Profile Dashboard" style="width:100%; max-width:900px; margin-bottom:20px; border-radius: 8px; border: 1px solid #ccc;">
...
<img src="{{ site.baseurl }}/assets/images/distribution%20of%20citizenship%20across%20malls.png" alt="Citizenship Distribution" style="width:100%; max-width:800px; margin-bottom:20px; border-radius: 8px; border: 1px solid #ccc;">
